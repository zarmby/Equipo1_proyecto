        ...
        <div class="Modal-Body">
          ...
          <div class="Asigned-Person">
            <div class="Asigned-Person-Elements">
              <a class="person-link" href={props.state == "Asignado" ? `user?account=${props.assignedUser}` : "#exitEquipment"}>
                {
                  props.state == "Asignado"
                    ?
                    asignedName[0]
                    :
                    props.state == "Disponible"
                      ?
                      "No asignado"
                      :
                      asignedName[0] != "undefined undefined"
                        ?
                        asignedName[0]
                        :
                        "No asignado"
