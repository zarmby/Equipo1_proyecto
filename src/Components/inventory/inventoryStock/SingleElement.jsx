...
render(){
  ...
  return(
    ...
    onClick={() => handlePanelShow(this.props.serialnumber,this.props.mark,this.props.model,this.props.enviroment,this.props.description,this.props.state)}>
      ...
      <div class="card__overlay">
        ...
        <div class="card__description">
          <p><strong>N/S /</strong> {this.props.serialnumber}</p>
          <p><strong>Model /</strong> {this.props.model}</p>
          <p><strong>Marca /</strong> {this.props.mark}</p>
        </div>
      </div>
    </div>
  );
